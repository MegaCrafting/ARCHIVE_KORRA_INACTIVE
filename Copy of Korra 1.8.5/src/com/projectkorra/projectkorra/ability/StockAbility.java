...
public enum StockAbility {
	...
	public enum ScarecrowAbilities {
		;
	}

	public enum SnowmanAbilities {
		;
	}
	
	public static boolean isScarecrow(StockAbility ability) {
		for (ScarecrowAbilities a : ScarecrowAbilities.values()) {
	...
	public static boolean isSnowman(StockAbility ability) {
		for (SnowmanAbilities a : SnowmanAbilities.values()) {
			if (a.name().equalsIgnoreCase(ability.name())) {
				return true;
			}
		}
